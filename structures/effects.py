...
class Effects:
    ...
    class Pitch(EffectCategory):
        ...
        class VibratoEffects(EffectCategory):
            settingsName = "VibratoSettings"

            class SettingsValue(NamedTuple):
                pass

            class Vibrato(AbstractEffect):
                displayName = "Vibrato"
                prefix = (0x21,)  # TODO:
                params = [
                    "21pprr",
                ...
                def actuate(
                    ...
                    def loop(_: None):
                        ...
                        channel.playbackState.pitchBends[cls.bendName] = (
                            offset * data.range
                        )
                    ...
                    if len(data) == 0:
                        value = channel.playbackState.effectData.get(
                            cls.storeName, None
                        )
                        ...
                        if data == (0, 0):
                            ...
                            if type(value) is cls.StoreValue:
                                if value.active == True:
                                    value.phase = int(
                                        mapRange(
                                            0, value.period, 0, period, value.phase
                                        )
                                    )
                                else:
                                    value.phase = 0
            ...
            class VibratoSetup(AbstractEffect):
